...
ScrollReveal().reveal('.home-img, .services-container, .portfolio-box, .top-header, .timeline-item, .contact form',  { origin: 'bottom' });
ScrollReveal().reveal('.home-container h1, .about-img ',  { origin: 'left' });
ScrollReveal().reveal('.home-container p, .about-img, .about-content ',  { origin: 'right' });
